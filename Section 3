# Permutation Inference: How rare was the data we got assuming that the treatment had no effect? We will first run the
# analysis with a treatment effect of 1.
